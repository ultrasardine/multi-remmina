...
/* Feature: macos-port, Property 5: Connection Profile Persistence Round-Trip */
...
static gboolean prop_profile_persistence_roundtrip(void)
{
	...
	/* Note: Password verification is handled separately by Keychain tests on macOS
...
/* Feature: macos-port, Property 6: Profile Listing Completeness */
...
int main(int argc, char *argv[])
{
	...
	g_print("=== Profile Management Property-Based Tests ===\n\n");
